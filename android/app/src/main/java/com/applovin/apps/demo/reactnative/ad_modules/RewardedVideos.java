        ...
        extends AdModule
{
    ...
    public RewardedVideos(ReactApplicationContext reactContext)
    {
        super( reactContext );
    }
    ...
    public void initAd()
    {
        mIncentivizedInterstitial = AppLovinIncentivizedInterstitial.create( getReactApplicationContext() );
        mIncentivizedInterstitial.setUserIdentifier( "DEMO_USER_IDENTIFIER" ); // Set an optional user identifier used for S2S callbacks
    }
    ...
    public void preloadAd()
    {
        mIncentivizedInterstitial.preload( new AppLovinAdLoadListener()
        {
            ...
            {
                log( "Rewarded video failed to load with error code " );
            }
        } );
    }
    ...
    public void showAd()
    {
        ...
        mIncentivizedInterstitial.show( getCurrentActivity(), adRewardListener, adVideoPlaybackListener, adDisplayListener, adClickListener );
    }
}
